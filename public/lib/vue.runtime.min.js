...
!(function(t, e) {
  ...
  function o(t) {
    return (
      'string' == typeof t || 'number' == typeof t || 'symbol' == typeof t || 'boolean' == typeof t
    )
  }
  function i(t) {
  ...
  function Ot(t, e) {
    ...
    for (var n, r, o, i = rt ? Reflect.ownKeys(e) : Object.keys(e), a = 0; a < i.length; a++)
      '__ob__' !== (n = i[a]) &&
        ((r = t[n]), (o = e[n]), m(t, n) ? r !== o && s(r) && s(o) && Ot(r, o) : $t(t, n, o))
    return t
  }
  function kt(t, e, n) {
    return n
    ...
    if (!e(o)) {
      ...
      if ((i(o) && (o = f.extend(o)), 'function' == typeof o)) {
            ...
            (o = (function(t, o) {
              ...
              if (a && !n(t.owners)) {
                ...
                return (
                  i(d) &&
                    (u(d)
                      ? e(t.resolved) && d.then(f, p)
                      : u(d.component) &&
                        (d.component.then(f, p),
                        n(d.error) && (t.errorComp = Re(d.error, o)),
                        n(d.loading) &&
                          ((t.loadingComp = Re(d.loading, o)),
                          0 === d.delay
                            ? (t.loading = !0)
                            : setTimeout(function() {
        ...
        return new lt(
          ...
          void 0,
          s,
          { Ctor: o, propsData: d, listeners: h, tag: l, children: c },
          p
        )
      }
    }
  ...
  var un = { enumerable: !0, configurable: !0, get: k, set: k }
  function ln(t, e, n) {
    ;(un.get = function() {
      return this[e][n]
    }),
      ...
      e.data
        ? (function(t) {
            ...
            for (; o--; ) {
              var i = n[o]
              ;(r && m(r, i)) ||
                ((a = void 0), 36 !== (a = (i + '').charCodeAt(0)) && 95 !== a && ln(t, '_data', i))
            }
            var a
            Ct(e, !0)
          })(t)
      ...
      e.computed &&
        (function(t, e) {
          ...
          for (var o in e) {
            ...
            r || (n[o] = new cn(t, a || k, k, pn)), o in t || dn(t, o, i)
          }
        })(t, e.computed),
      e.watch &&
        e.watch !== Z &&
        (function(t, e) {
          for (var n in e) {
            var r = e[n]
            if (Array.isArray(r)) for (var o = 0; o < r.length; o++) mn(t, n, r[o])
            else mn(t, n, r)
          }
        })(t, e.watch)
  }
  ...
  function dn(t, e, n) {
    var r = !Y()
    'function' == typeof n
      ? ((un.get = r ? vn(e) : hn(n)), (un.set = k))
      : ((un.get = n.get ? (r && !1 !== n.cache ? vn(e) : hn(n.get)) : k), (un.set = n.set || k)),
    ...
    e.prototype._init = function(e) {
      ...
      ;(n._uid = yn++),
        ...
        e && e._isComponent
          ...
          : (n.$options = Tt(gn(n.constructor), e || {}, n)),
        (n._renderProxy = n),
        (n._self = n),
        (function(t) {
          var e = t.$options,
        ...
        (function(e) {
          ...
          var i = r && r.data
          wt(e, '$attrs', (i && i.attrs) || t, null, !0),
            wt(e, '$listeners', n._parentListeners || t, null, !0)
        })(n),
        Ze(n, 'beforeCreate'),
        (function(t) {
  ...
  !(function(t) {
    ...
    Object.defineProperty(t, 'config', e),
      (t.util = { warn: ot, extend: x, mergeOptions: Tt, defineReactive: wt }),
      (t.set = $t),
      (t.delete = At),
      (t.nextTick = Zt),
    ...
    Object.defineProperty(_n.prototype, '$isServer', { get: Y }),
    Object.defineProperty(_n.prototype, '$ssrContext', {
      get: function() {
        return this.$vnode && this.$vnode.ssrContext
      },
    }),
    Object.defineProperty(_n, 'FunctionalRenderContext', { value: ke }),
    (_n.version = '2.6.9')
  ...
  function Mn(t) {
    for (var e = t.data, r = t, o = t; n(o.componentInstance); )
      (o = o.componentInstance._vnode) && o.data && (e = Fn(o.data, e))
    for (; n((r = r.parent)); ) r && r.data && (e = Fn(e, r.data))
    return (function(t, e) {
      if (n(t) || n(e)) return Rn(t, Un(e))
      return ''
  ...
  function er(t, e) {
    ;(t.data.directives || e.data.directives) &&
      (function(t, e) {
        ...
        if (!i) for (n in s) c[n] || ir(s[n], 'unbind', t, t, a)
      })(t, e)
  }
  ...
  function rr(t, e) {
    ...
    for (n = 0; n < t.length; n++)
      (r = t[n]).modifiers || (r.modifiers = nr),
        (o[or(r)] = r),
  ...
  function sr(t, r) {
    ...
    if (!((n(o) && !1 === o.Ctor.options.inheritAttrs) || (e(t.data.attrs) && e(r.data.attrs)))) {
      ...
      for (i in (n(u.__ob__) && (u = r.data.attrs = x({}, u)), u))
        (a = u[i]), c[i] !== a && cr(s, i, a)
      for (i in ((W || K) && u.value !== c.value && cr(s, 'value', u.value), c))
        e(u[i]) && (Nn(i) ? s.removeAttributeNS(Dn, Pn(i)) : En(i) || s.removeAttribute(i))
    }
  }
  function cr(t, e, n) {
    t.tagName.indexOf('-') > -1
      ...
      ? Ln(n)
        ...
        : ((n = 'allowfullscreen' === e && 'EMBED' === t.tagName ? 'true' : e),
          t.setAttribute(e, n))
      : En(e)
      ? t.setAttribute(e, Tn(e, n))
      : Nn(e)
      ? Ln(n)
        ? t.removeAttributeNS(Dn, Pn(e))
  ...
  var Er,
    ...
    Dr = ['Webkit', 'Moz', 'ms'],
    Nr = y(function(t) {
      if (((Er = Er || document.createElement('div').style), 'filter' !== (t = _(t)) && t in Er))
        return t
      ...
      var d = (function(t, e) {
        ...
        if (e)
          for (var o = t; o.componentInstance; )
            (o = o.componentInstance._vnode) && o.data && (n = kr(o.data)) && x(r, n)
        ;(n = kr(t.data)) && x(r, n)
  ...
  function eo(t, e) {
    ...
    return (
      e === Br
        ...
        : (f = (n = (l = Math.max(a, u)) > 0 ? (a > u ? Br : zr) : null)
            ? n === Br
              ? i.length
              : c.length
            : 0),
      { type: n, timeout: l, propCount: f, hasTransform: n === Br && to.test(r[Wr + 'Property']) }
    )
  }
  function no(t, e) {
      ...
      if (!k || C || '' === C) {
        var S = k && d ? d : u,
          ...
          R = (o._enterCb = I(function() {
            M && (Qr(o, j), Qr(o, E)),
              R.cancelled ? (M && Qr(o, S), P && P(o)) : N && N(o),
              (o._enterCb = null)
          }))
        t.data.show ||
      ...
      var s = a.css,
        ...
        w = (o._leaveCb = I(function() {
          o.parentNode && o.parentNode._pending && (o.parentNode._pending[t.key] = null),
            _ && (Qr(o, l), Qr(o, p)),
            w.cancelled ? (_ && Qr(o, u), m && m(o)) : (r(), h && h(o)),
            (o._leaveCb = null)
        }))
      y ? y($) : $()
    }
  ...
  var uo = (function(t) {
      ...
      if (n(e) || n(t.data)) {
        ...
        for (
          n(e)
            ...
            n((r = t.componentInstance)) && n((r = r._vnode)) && n(r.data) && w(r, e),
            r = 0;
          r < s.remove.length;
          ++r
        )
    ...
    function k(t, e, o, i) {
      ...
      if (n(c) && (n((a = c.hook)) && n((a = a.init)) && a(e, !0), n((a = e.componentInstance))))
        return d(e, o), !0
      if (n(s)) {
        if (n(u))
          if (t.hasChildNodes())
  ...
  var xo = function(t) {
    ...
    So = x({ tag: String, moveClass: String }, Co)
  function Eo(t) {
                ...
                n.addEventListener(
                  ...
                  (n._moveCb = function t(r) {
                    ;(r && r.target !== n) ||
                      ...
                      (n.removeEventListener(qr, t), (n._moveCb = null), Qr(n, e))
                  })
                )
            }
          }))
  ...
  return (
    ...
    x(_n.options.directives, bo),
    x(_n.options.components, Io),
    (_n.prototype.__patch__ = H ? uo : k),
